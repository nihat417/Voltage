...
partial class VoltageDbContextModelSnapshot : ModelSnapshot
{
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("Voltage.Entities.Entity.FriendList", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int");
        ...
        modelBuilder.Entity("Voltage.Entities.Entity.Notification", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int");
        ...
        modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
            {
                b.HasOne("Voltage.Entities.Entity.User", null)
                    .WithMany()
        ...
        modelBuilder.Entity("Voltage.Entities.Entity.Notification", b =>
            {
                b.HasOne("Voltage.Entities.Entity.User", "Receipent")
                    .WithMany("Receipent")
                    .HasForeignKey("ReceipentId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.Navigation("Receipent");
            });
