document.addEventListener("DOMContentLoaded", _ => {
    const passwordInput = document.getElementById("password-input"),
        ...
        showPasswordToggle2 = document.getElementById("show-password-toggle2"),
    ...
    showPasswordToggle2.addEventListener("click", event => {
        event.preventDefault();
        togglePasswordVisibility(passwordInput2, showPasswordToggle2);
    });
